...
for section_name, section_path in zip(section_list, section_path_list):
    ...
    chapter_content = ""
    # Build chapter.typ by including all .typ files in the section (excluding chapter.typ itself)
    ...
    # Write the chapter.typ file so Typst can include the section contents
